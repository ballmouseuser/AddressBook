...
public class TableViewFactory {
	 ...
	 * 
	 * @param tableView 빈껍데기(컬럼과 데이터가 없는) 테이블뷰 객체를 전달한다.
	 * 
	 * @param voClazz 테이블뷰에 반영시킬 vo클래스를 지정
	 * 
	 */
	...
	/**
	 * 질의와 커넥션 객체를 받아 테이블뷰를 만들어주는 메소드
	 * @param sql 데이터베이스 select 질의를 문자열로 보낸다.
	 * @param conn 커넥션객체를 전달한다.
	 * @return 테이블뷰가 만들어져 리턴된다.
	 */
